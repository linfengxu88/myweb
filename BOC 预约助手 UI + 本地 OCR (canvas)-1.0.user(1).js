// ==UserScript==
// @name         BOC 预约助手 UI + 本地 OCR (canvas)
// @namespace    https://example.com/
// @version      1.0
// @description  浮窗填写基本信息 + 省市区 + tesseract.js 识别验证码（canvas 获取图像）
// @match        https://cmcoins.boc.cn/BOC15_CoinSeller/*
// @grant        GM_addStyle
...
(function () {
  ...
  async function selectCascade() {
    ...
    const delayAfterClick = [120, 350, 0];
